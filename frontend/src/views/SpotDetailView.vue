...
async function loadSpot() {
  ...
  if (!Number.isFinite(id)) { ElMessage.error('景点 ID 不正确'); router.push('/visitor/spots'); return }
  loading.value = true
...
<template>
  <AppLayout title="景点详情" description="查看景点位置、开放时间和游览信息。" role-label="游览服务">
